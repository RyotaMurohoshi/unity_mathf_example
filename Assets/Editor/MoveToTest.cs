...
public class MoveToTest
{
    ...
    public void MoveToWardsAngleTest()
    {
        ...
        Assert.That(Mathf.MoveTowardsAngle(current: -0.25F, target: 360.0F, maxDelta: 1.0F), Is.EqualTo(360.0F));
        Assert.That(Mathf.MoveTowardsAngle(current: 0.25F, target: 360.0F, maxDelta: 1.0F), Is.EqualTo(360.0F));
        Assert.That(Mathf.MoveTowardsAngle(current: 1.0F, target: 360.0F, maxDelta: 1.0F), Is.EqualTo(0.0F));
        Assert.That(Mathf.MoveTowardsAngle(current: 5.0F, target: 360.0F, maxDelta: 1.0F), Is.EqualTo(4.0F));
        ...
        Assert.That(Mathf.MoveTowardsAngle(current: 359.75F, target: 0.0F, maxDelta: 1.0F), Is.EqualTo(0.0F));
        Assert.That(Mathf.MoveTowardsAngle(current: 360.25F, target: 0.0F, maxDelta: 1.0F), Is.EqualTo(0.0F));
